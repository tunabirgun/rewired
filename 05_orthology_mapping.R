...
fgr_aliases <- load_string_aliases(file.path(STRING_NET_DIR, "229533.protein.aliases.v12.0.txt"), "229533")
fox_aliases <- load_string_aliases(file.path(STRING_NET_DIR, "426428.protein.aliases.v12.0.txt"), "426428")
