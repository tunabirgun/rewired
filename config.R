...
# Gulfidan et al. (2020), Sci Rep 10:3272, doi:10.1038/s41598-020-60127-x
...
DEGS_DIR      <- file.path(BASE_DIR, "data", "degs")
METADATA_DIR  <- file.path(SCRIPT_DIR, "inputs")   # bundled external inputs
STRING_DIR    <- file.path(SCRIPT_DIR, "inputs")   # bundled external inputs
STRING_NET_DIR <- file.path(BASE_DIR, "string_data")  # large STRING network + aliases (external, not committed)
...
for (d in c(RESOURCE_DIR, OUTPUT_DIR, DI_DIR, DE_DIR, REWIRED_DIR, ENRICH_DIR,
...
# --- Thresholds ---
# Q-value and DELTA thresholds from Gulfidan et al. (2020), Sci Rep 10:3272, doi:10.1038/s41598-020-60127-x
