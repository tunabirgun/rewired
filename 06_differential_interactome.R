...
#
# Algorithm reference: Gulfidan et al. (2020), Sci Rep 10:3272, doi:10.1038/s41598-020-60127-x
#
# Steps:
...
ppi_raw <- read_delim(file.path(STRING_NET_DIR, "229533.protein.links.v12.0.txt"),
